...
public class GaService {
    ...
    public List<GaUserPatternResponse> getUserFeatureUsage(String userId) {
        List<GaUserPatternResponse> results = gaUserPatternRepository.getUserFeatureUsage(userId);
